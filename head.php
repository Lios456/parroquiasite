      ...
      <div class="container">
        <div class="d-flex justify-content-between align-items-center py-3">
          <a class="navbar-brand" href="index.html">
            <img src="images/main-logo.png" class="logo img-fluid" width="15%">
          </a>
          ...
          <div class="offcanvas-body align-items-center justify-content-center">
            <ul class="navbar-nav mb-2 mb-lg-0">
              <li class="nav-item px-3 py-1 py-lg-0">
                <a class="nav-link active p-0" aria-current="page" href="index.php">Inicio</a>
              </li>
              ...
              <li class="nav-item px-3 py-1 py-lg-0">
                <a class="nav-link p-0" href="index.php">Sobre Nosotros</a>
              </li>
              <li class="nav-item px-3 py-1 py-lg-0">
                <a class="nav-link p-0" href="index.php">Noticias</a>
              </li>
              <li class="nav-item px-3 py-1 py-lg-0">
                <a class="nav-link p-0" href="index.php">Catequesis</a>
              </li>
              <li class="nav-item px-3 py-1 py-lg-0">
